 ...
 * @Last Modified Time: 2022-03-22 19:02:46
 */
...
void usage(string &program) {
  cerr << "\nProgram Usage: \n"
       ...
       << "   search    Search lineage from lineage files and NCBI taxonomy database\n"
       << "   leaf      Obtain the species name list of phylogenetic tree\n"
       << "   rank      Output the default rank names and abbrevations\n"       
